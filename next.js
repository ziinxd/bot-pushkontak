...
console.log(color(figlet.textSync(`CHANEL`, {
font: 'Standard',
horizontalLayout: 'default',
vertivalLayout: 'default',
whitespaceBreak: false
}), 'white'))
console.log(color('ㅤInfo Script Bot\nㅤ➺ Baileys : Multi Device\nㅤ➺ Nama Script : Push Kontak V3\n\nㅤInfo Creator\nㅤ➺ My YouTube : MTS4YOU CHANEL\nㅤ➺ My Instagram : @ig_mtsstore\nㅤ➺ My WhatsApp : 628989105685', 'yellow'))
